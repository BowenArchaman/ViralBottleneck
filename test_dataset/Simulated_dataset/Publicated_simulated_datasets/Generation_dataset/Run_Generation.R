...
setwd("/home3/2748683z/R_pub/First_simulation/GenerationDataset_noerror/R_input")
transmission_pairs = read.table("Generation_transmission_pairs.csv",header = TRUE,sep = ",")

...
setwd("/home3/2748683z/R_pub/First_simulation/CoverageDataset_noerror/R_input")
transmission_pairs = read.table("Coverage_transmission_pairs.csv",header = TRUE,sep = ",")

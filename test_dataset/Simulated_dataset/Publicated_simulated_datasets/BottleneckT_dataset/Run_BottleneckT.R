...
setwd("/home3/2748683z/R_pub/First_simulation/BottleneckTDataset_noerror/R_input")
transmission_pairs = read.table("BottleneckT_transmission_pairs.csv",header = TRUE,sep = ",")
